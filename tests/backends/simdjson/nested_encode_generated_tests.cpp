...
TEST_CASE("optional.object_error_path", "[simdjson][encoder]") {
    app::OptionalUser value;
    value.address = app::Address{std::string{"\xC3\x28", 2}};
    cjm::simdjson::EncodeError error;
...
TEST_CASE("optional.object_recovers", "[simdjson][encoder]") {
    app::OptionalUser value;
    value.address = app::Address{std::string{"\xC3\x28", 2}};
    cjm::simdjson::EncodeError error;
